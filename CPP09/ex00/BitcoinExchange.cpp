...
static int	checkline(std::string line, char delim)
{
	...
	while (i != line.size())
	{
		...
		if (i == 4 && line[i] != '-')
			return (1);
		if ((i >= 5 && i <= 6) && ((std::isdigit(line[i]) == 0) || (line[5] >= '2') || (line[5] == '1' && line[6] >= '3') || (line[5] == '0' && line[6] == '0')))
			return (1);
		if (i == 7 && line[i] != '-')
			return (1);
		if ((i >= 8 && i <= 9) && ((std::isdigit(line[i]) == 0) || (line[8] >= '4') || (line[8] == '3' && line[9] >= '2') || (line[5] == '0' && (line[6] == '4' || line[6] == '6' || line[6] == '9') && line[8] == '3' && line[9] != '0') || (line[5] == '1' && line[6] == '1' && line[8] == '3' && line[9] != '0') || (line[5] == '0' && line[6] == '2' && line[8] > '2') || (line[8] == '0' && line[9] == '0')))
			return (1);

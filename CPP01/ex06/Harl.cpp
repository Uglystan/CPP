...
/*   Updated: 2023/07/26 10:17:16 by lgirault         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Harl::complain(std::string argv1)
{
	int	level_filtre = 0;
	...
	while (level_filtre < 4 && tab_index[level_filtre] != argv1)
		level_filtre++;
	level_filtre++;
	...
	des arguments a la fonction ici comme nos fonction sont prototype pour ne pas en prendre on laisse vide de plus on utilise un switch qui,
	en fonction du filtre passer en parametre au debut du programme on affiche plus ou moin d'action*/
	switch (level_filtre)
	{
		case 1:
			(this->*tab_ptr_ft[0])();
